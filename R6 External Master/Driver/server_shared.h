...
enum class PacketType
{
	...
	uni_packet_clean_piddbcachetable,
	uni_clean_mmunloadeddrivers,
	uni_hwid_spoofing,
	uni_completed
};
...
struct Packet
{
	...
	union
	{
		...
		PacketCleanPiDDBCacheTable uni_clean_piddbcachetable;
		PacketCleanMMUnloadedDrivers uni_clean_mmunloadeddrivers;
		PacketHwidSpoofing uni_hwid_spoofing;
