...
uint64_t driver::clean_piddbcachetable(const SOCKET connection)
{
	...
	packet.uni_header.uni_magic = packet_magic;
	packet.uni_header.uni_type = PacketType::uni_packet_clean_piddbcachetable;

	auto& data = packet.data.uni_clean_piddbcachetable;
...
uint64_t driver::clean_mmunloadeddrivers(const SOCKET connection)
{
	...
	packet.uni_header.uni_magic = packet_magic;
	packet.uni_header.uni_type = PacketType::uni_clean_mmunloadeddrivers;

	auto& data = packet.data.uni_clean_mmunloadeddrivers;
...
uint64_t driver::hwid_spoofing(const SOCKET connection)
{
	...
	packet.uni_header.uni_magic = packet_magic;
	packet.uni_header.uni_type = PacketType::uni_hwid_spoofing;

	auto& data = packet.data.uni_hwid_spoofing;
...
uint32_t driver::copy_memory(const SOCKET connection, const uint32_t src_process_id, const uintptr_t src_address, const uint32_t dest_process_id, const uintptr_t dest_address, const size_t size)
{
	Packet packet{ };
